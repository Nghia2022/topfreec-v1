...
class Account::FcCompany < Account
  has_many :contacts, foreign_key: :accountid, primary_key: :sfid, dependent: :restrict_with_exception

  # disabled :reek:UtilityFunction
  # :nocov:
  def matchings
    Matching.none
  end
