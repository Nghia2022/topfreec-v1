...
class Account::Fc < Account
  has_many :fc_users, foreign_key: :account_sfid, primary_key: :sfid
  has_many :contacts, foreign_key: :accountid, primary_key: :sfid
  belongs_to :person, class_name: 'Contact', foreign_key: :personcontactid, primary_key: :sfid, optional: true
  has_many :matchings, foreign_key: :fc__c, primary_key: :sfid
  has_many :projects, foreign_key: :fc__c, primary_key: :sfid
  has_many :directions, through: :projects
  has_many :work_histories, through: :contacts
  has_many :experiences, through: :contacts
end
